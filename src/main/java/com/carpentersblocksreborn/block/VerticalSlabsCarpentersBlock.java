...
public class VerticalSlabsCarpentersBlock extends WaterloggableCarpentersBlock {
    ...
    public VerticalSlabsCarpentersBlock(Supplier<BlockState> state, Properties properties) {
       super(properties);
